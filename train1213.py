...
semantic3d_batch_num_val = int(math.ceil(semantic3d_num_val / BATCH_SIZE_VAL))
print('{}-{:d} semantic 3d validation batches per test.'.format(datetime.now(), semantic3d_batch_num_val))
npm3d_batch_num_val = int(math.ceil(npm3d_num_val / BATCH_SIZE_VAL))
