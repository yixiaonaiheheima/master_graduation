...
def main():
    ...
    root = FOLDER if FOLDER else '/home/yss/sda1/yzl/Data/Semantic3D/'
        ...
        for dataset_idx, dataset in enumerate(datasets):
            ...
            for offset_name, offset in offsets:
                ...
                for block_idx in range(idx_last_non_empty_block + 1):
                    ...
                    xyz_grids = np.floor((block_points - block_min) / GRID_SIZE).astype(np.int)  # (n1, 3)
                ...
                for block_idx in range(idx_last_non_empty_block + 1):
                    ...
                    # use correct order 'x, y, z'
                    block_xyzrgbi = np.concatenate([x, y, z, rgb[point_indices], i[point_indices]], axis=-1)  # (n1, 7)
                    ...
                    for block_split_idx in range(block_split_num):
                        ...
                        data[idx_in_batch, 0:point_num, ...] = block_xyzrgbi[start:end, :]
